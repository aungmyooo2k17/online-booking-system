...
import { stringToDate } from 'formatters';
            ...
            render={({ onChange, value }) => {
              return (
                <>
                  {readOnly ? (
                    <input
                      defaultValue={value && formatDate(stringToDate(value), format)}
                    ...
                    <div className="relative">
                      <DayPickerInput
                        ...
                        {...rest}
                        // {...(value && { value })}
                        // Note: value formated to 'dd-MMM-yyyy'
                        {...(value && { value: formatDate(stringToDate(value), format) })}
                        format={format}
                        readonly={true}
                        keepFocus={false}
                      ...
                      {value && !disabled && (
                        <i
                          className="absolute text-sm fas fa-times reset-button"
