    ...
    <div className="flex flex-col lg:flex-row bg-white rounded-lg shadow-md overflow-hidden mb-4">
      ...
      <div className="p-4 ml-4 flex-1">
        <div className="flex items-center justify-between">
          <h3 className="pb-4 text-xs font-semibold text-green-500">{car.price}</h3>
          <button
        ...
        <span className={`text-lg font-semibold text-gray-900`}>{car.model_name}</span>
        <div className="pt-4 grid grid-cols-2">
          <div>
            <FontAwesomeIcon icon={faRoad} />
            <span className="ml-2 text-gray-500">{car.no_of_seater} seaters</span>
          </div>
          <div>
            <FontAwesomeIcon icon={faGasPump} />
            <span className="ml-2 text-gray-500">{car.type}</span>
          </div>
        </div>
        <div className="mt-4 grid grid-cols-2">
          <div>
            <FontAwesomeIcon icon={faCalendar} />
            <span className="ml-2 text-gray-500">{car.model_year}</span>
          </div>
          <div>
            <FontAwesomeIcon icon={faGears} />
            <span className="ml-2 text-gray-500">{car.engine_litre} hp</span>
          </div>
        </div>
      </div>
